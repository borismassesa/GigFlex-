...
export default function EarningsScreen() {
  ...
  const handleTabPress = (tab: string) => {
    if (tab === 'activity') {
      router.push('/earnings/activity');
    } else if (tab === 'wallet') {
      router.push('/earnings/wallet');
    }
  };
  ...
  const renderTabs = () => (
    <View style={[styles.tabs, { backgroundColor: colors.backgroundAlt }]}>
      ...
      >
        <BarChart3 size={20} color={colors.textDim} />
        <Text style={[styles.tabText, { color: colors.textDim }]}>Activity</Text>
      </TouchableOpacity>
      ...
      >
        <Wallet size={20} color={colors.textDim} />
        <Text style={[styles.tabText, { color: colors.textDim }]}>Wallet</Text>
      </TouchableOpacity>
      
      <TouchableOpacity style={[styles.tab]}>
        <Award size={20} color={colors.textDim} />
        <Text style={[styles.tabText, { color: colors.textDim }]}>Benefits</Text>
      </TouchableOpacity>
    </View>
  );
